...
import Instrument from "../elements/Instrument";
...
import PullOutMenu from "../elements/PullOutMenu";
import Instruments from "../elements/Instruments";
      ...
      <div className="dashboard">
        ...
        <div className="dashboard__header">
          ...
          <form className="dashboard__condition" onSubmit={handleSubmit}>
            ...
            >
              <option value="notMarked">Не размечен</option>
              <option value="inProgress">В процессе разметки</option>
              <option value="marked">Размечен</option>
